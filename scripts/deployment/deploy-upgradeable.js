...
async function main() {
    ...
    try {
        ...
        console.log("\n1️⃣  Deploying DataStreamNFTUpgradeable implementation...");
        ...
        console.log("\n3️⃣  Preparing initialization data...");
        ...
        console.log("\n4️⃣  Deploying TransparentUpgradeableProxy...");
        ...
        console.log("\n5️⃣  Creating contract instance...");
        ...
        console.log("   🏷️  Symbol:", dataStreamNFTSymbol);
